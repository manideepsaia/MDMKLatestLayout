...
export class MapDocumnetsComponent implements OnInit {
 ...
 Filteredpatients() {
  ...
  const selectedPractice = this.form.value.practice;
...
// this.model.patientItem=formvalue.patientItem;
 ...
 // this.model.dob=this.updatedDob;
  const page_number = ((formvalue.pageNumber).join(','));
...
save() {
    console.log('in save');
    this.deletedisabled = false;
    const formvalue = JSON.stringify(this.model);
    ...
    const id = this.model.patientItem;
   ...
   // this.storagemodel.push(this.model);
    ...
    const lcstrge = JSON.parse(localStorage.getItem('model'));
  ...
  editMapDoc(mapDetails, index, value: any) {
    ...
    if (typeof mapDetails.pageNumber === 'string') {
      const page_number = ((mapDetails.pageNumber).split(','));
      this.pageNumber = page_number;
    } else {
         const page_number = mapDetails.pageNumber;
          this.pageNumber = page_number;
    }
 ...
 // this.index=null;
  ...
  Cancel() {
    ...
    if (typeof this.mapDetails.pageNumber === 'string') {
      const page_number = ((this.mapDetails.pageNumber).split(','));
      this.pageNumber = page_number;
    } else {
         const page_number = this.mapDetails.pageNumber;
          this.pageNumber = page_number;
    }
