...
const appRoutes: Routes = [
    ...
    { path: 'dashboard', component: AdminComponent, canActivate: [AuthGuard, AdminGuard] },
    { path: 'admin/users', component: AdminUsersComponent, canActivate: [AuthGuard, AdminGuard] },
    {
        path: 'mdmuser',
        component: MdmUserComponent, canActivate: [AuthGuard, MdmUserGuard],
...

    {
      ...
      path: 'mdmuser/mapDocuments',
      component: MapDocumnetsComponent, canActivate: [AuthGuard, MdmUserGuard]
